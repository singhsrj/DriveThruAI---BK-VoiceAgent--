"""
SQLAlchemy models for the BK menu DB, targeting Neon Postgres.

Matches the final schema shape reached through the SQLite migration
scripts (seed_real_menu.py -> merge_sides_into_snacks.py ->
migrate_combos_veg_nonveg.py):
